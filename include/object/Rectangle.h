...
class Rectangle: public GeometricObject {
	public:
        ...
        Rectangle(const Point3D& _p0, const Vector3D& _a, const Vector3D& _b, const float map_unit_a, const float map_unit_b);
	...
	private:
        ...
        float          map_unit_a;     // for texture mapping
        float          map_unit_b;     // for texture mapping
